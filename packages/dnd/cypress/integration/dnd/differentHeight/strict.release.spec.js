...
context("Moving Element Strict - Up/Down - Releasing the dragged", () => {
  before(() => {
  ...
  it("Siblings have new positions", () => {
    cy.get("#mtg").should("have.css", "transform", "matrix(1, 0, 0, 1, 0, 0)");

    cy.get("#org").should("have.css", "transform", "matrix(1, 0, 0, 1, 0, 0)");
