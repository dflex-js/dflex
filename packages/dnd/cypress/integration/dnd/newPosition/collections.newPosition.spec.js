...
context("DnD/Testing a collections new positions", () => {
  ...
  context("Moving element 9 down outside the list then moving it up", () => {
    it("Clicks element 9", () => {
    ...
    it("Moving element 9 out down, one position switching with 10", () => {
    ...
    it("Moving element 9 out down, one position switching with 11", () => {
      cy.get("#id-9").trigger("mousemove", {
        clientX: startingPointX,
    ...
    it("Moving element 9 out down, one position switching with 12", () => {
      cy.get("#id-9").trigger("mousemove", {
        clientX: startingPointX,
    ...
    it("Moving element 9 out down, outside the list", () => {
      cy.get("#id-9").trigger("mousemove", {
        clientX: startingPointX,
    ...
    it("Moving element 9 up, inside the list to replace 12", () => {
